...
if __name__ == '__main__':
    ...
    places = api.search_geo(lat="2.919733", long="101.654423", max_results = 2000)
    place_id = places[0].id
    tweets = Cursor(api.search_tweets,q="(public transport)", lang="en", geocode = "2.919733,101.654423,10000mi").items(3000)
    tweet2 = []
    for tweet in tweets:
      tweet2.append(tweet)

    df = tweet_analyzer.tweets_to_data_frame(tweet2)
